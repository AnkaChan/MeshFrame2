...
#ifndef  _MESHFRAME_VERTEX_H_
#define  _MESHFRAME_VERTEX_H_
	...
	namespace TriMesh {
		...
		*/
		...
		public:
			...
			/*!
			CVertexBase constructor
			*/
			CVertexBase() { m_halfedge = NULL; m_boundary = false; };
			/*!
			CVertexBase destructor
			*/
			~CVertexBase() {};
	  ...
	  */
		inline CHalfEdge* CVertexBase::most_ccw_in_halfedge()
		{
			//for interior vertex
			if (!m_boundary)
			{
		...
		inline CHalfEdge* CVertexBase::most_clw_in_halfedge()
		{
			//for interior vertex 
			if (!m_boundary)
			{
		...
		inline CHalfEdge* CVertexBase::most_ccw_out_halfedge()
		{
			//for interior vertex
			if (!m_boundary)
			{
		...
		inline CHalfEdge* CVertexBase::most_clw_out_halfedge()
		{
			//for interior vertex
			if (!m_boundary)
			{
